      ...
      <div class="container" style="padding-left: 0px; padding-right: 0px;">
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	     		<a id="_logo" style="color:#fff; font-size: 24px;" class="navbar-brand hidden-sm">后台管理系统</a>
	          <ul class="nav navbar-nav" id="topMenu">
				...
				<#--拥有 角色888888（管理员） ||  100004（系统控制）-->
				<@shiro.hasAnyRoles name='888888,100004'>
					<li class="dropdown ${(index==4)?string('active','')}">
						<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" class="dropdown-toggle" href="${basePath}/system/list.shtml">
							系统控制<span class="caret"></span>
						</a>
						<ul class="dropdown-menu">
								<li><a href="${basePath}/system/list.shtml">字典列表</a></li>
						</ul>
					</li>
				</@shiro.hasAnyRoles>	
				<#--拥有 角色888888（管理员） ||  100004（客户管理 ）-->
				<@shiro.hasAnyRoles name='888888,100005'>
					<li class="dropdown ${(index==5)?string('active','')}">
						<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" class="dropdown-toggle" href="${basePath}/customer/list.shtml">
							客户管理 <span class="caret"></span>
						</a>
						<ul class="dropdown-menu">
								<li><a href="${basePath}/customerInfo/list.shtml">字典列表</a></li>
						</ul>
					</li>
				</@shiro.hasAnyRoles>			                 
	          </ul>
